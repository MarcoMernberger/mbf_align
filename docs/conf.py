...
module_dir = os.path.join(__location__, "../src/mbf_align")
try:
...
try:
    from mbf_align import __version__ as version
except ImportError:
    pass
else:
    release = version
...
htmlhelp_basename = 'mbf_align-doc'
...
latex_documents = [
  ('index', 'user_guide.tex', u'mbf_align Documentation',
...
def setup(app):
    ...
    github_doc_root = "https://github.com/TyberiusPrime/mbf_align"
